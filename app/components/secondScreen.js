export default function SecondScreen () {
    return(
        <div className="twoScreen" tabIndex="2" id='about'>
            ...
            سلام! <br/>
                 من ابوالفضلم و 19 سالَمه؛ <b>عاشقِ دنیایِ خلق‌کردنی‌ها</b> هستم.  توی هنرستان نرم‌افزار خوندم و در ادامه‌اش برای کشفِ بیش‌تر، <span className="font-hasti text-[30px] max-[750px]:text-[4vw]">الآن یک فرانت اند دولپراَم</span>. <br/>
